...
for file in glob.glob(file_pattern):
    ...
    result['PercentMajorReleases'] = (result['NewMajorReleases'])
...
plt.title('New Major Releases per Project (Combined)', fontsize=14)
plt.xlabel('Project', fontsize=12)
plt.ylabel('New Major Releases', fontsize=12)
